<template>
  <main
    ref="main"
    class="min-h-screen bg-slate-950 text-slate-100 lg:pl-[250px]"
  >
  ...
  <aside
    ref="sidebar"
    class="absolute lg:fixed z-[999] top-0 max-w-[0] opacity-0 lg:max-w-[250px] lg:opacity-100 w-[250px] h-dvh bg-slate-900 overflow-x-hidden"
  >
    <div class="px-3">
      ...
      <ul>
        <li class="mb-2">
          <UButton
            ...
            color="neutral"
            variant="soft"
            class="font-roboto font-semibold w-full"
            size="xl"
          />
        </li>
        <li class="mb-2">
